			...
			<div class="wrap-contact2">
				<form method="post" action="activa.php" class="contact2-form validate-form" autocomplete="off">
					<span class="contact2-form-title">
						...
						<hr>
						<a href="no_almuerzan/seleccion.php" style="text-decoration: none;">Mostrar usuarios que no almorzaron</a><br>
						<a href="si_almuerzan/seleccion.php" style="text-decoration: none; margin-left: 30px;">Mostrar usuarios qué sí almorzaron</a><br>
						<a href="repiten_almuerzo/seleccion.php" style="text-decoration: none; margin-left: 30px;">Mostrar usuarios qué repiten almuerzo</a>
					</span>
			</div>
		</div>
	</div>
