...
function Header()
{
	...
	$this->Cell(20, 10, 'Estado', 1/*Tenga contorno*/, 0/*Salto de linea*/, 'C'/*Texto centrado*/, 0/*Relleno*/);
    $this->Cell(25, 10, 'Especialidad', 1, 0, 'C', 0);
    $this->Cell(30, 10, 'Fecha-Recibido', 1, 1, 'C', 0);
}
...
$consulta = "SELECT * FROM estudiantes";//Traer todos los datos de la tabla estudiantes.
...
while ($row = $resultado->fetch_assoc()) {
	...
	$pdf->Cell(20, 10, 'S-'.$row['estado'], 1/*Tenga contorno*/, 0/*Salto de linea*/, 'C'/*Texto centrado*/, 0/*Relleno*/);
