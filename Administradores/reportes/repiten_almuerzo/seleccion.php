			...
			<div class="wrap-contact2">
				<form method="post" action="activa.php" class="contact2-form validate-form" autocomplete="off">
					<span class="contact2-form-title">
						...
						<br>
						<hr>
						<a href="repiten_almuerzo.php" style="text-decoration: none;">Mostrar reporte de usuarios que repiten almuerzo</a><br>
						<a href="index.php" target="_blank" style="text-decoration: none; margin-left: 30px;">Mostrar reporte de usuarios que repitieron almuerzo (.pdf)</a><br><br>
					</span>
				</div>
			</div>
		</div>
