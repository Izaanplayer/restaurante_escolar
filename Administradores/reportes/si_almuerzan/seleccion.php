	...
	<header>
		<nav class="menu">
			...
			<script language="JavaScript">
				function pregunta(){
					return confirm('¿Estas seguro de realizar esta acción?');
				}
			</script>
			...
			<div class="wrap-contact2">
				<form method="post" action="activa.php" class="contact2-form validate-form" autocomplete="off">
					<span class="contact2-form-title">
						...
						<br>
						<hr>
						<a href="si_almuerzan.php" style="text-decoration: none;">Mostrar reporte de usuarios que si almorzaron</a><br>
						<a href="index.php" target="_blank" style="text-decoration: none; margin-left: 30px;">Mostrar reporte de usuarios que si almorzaron (.pdf)</a><br><br>
					</span>
				</div>
			</div>
		</div>
