      ...
      <div class="wrap-contact2">
        <form method="post" action="activa.php" class="contact2-form validate-form" autocomplete="off">
          <span class="contact2-form-title">
            ...
            <a href="uno.php" style="text-decoration: none;">Seleccionar un sólo usuario</a>
            <a href="todos.php" style="text-decoration: none; margin-left: 30px;" target="_blank">Mostrar todos los usuarios</a>
          </span>
      </div>
    </div>
  </div>
